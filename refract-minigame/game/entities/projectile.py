...
class Projectile(GameObject):
    def __init__(self, projectile_id, x, y, direction_x, direction_y, owner_id, 
        ...
        Args:
            projectile_id: Unique identifier for this projectile
            x: Initial X position
            y: Initial Y position
            direction_x: X component of direction vector
            direction_y: Y component of direction vector
            owner_id: ID of the player who fired this projectile
            speed: Movement speed
            size: Collision size
            animation_name: Name of the animation to use
            damage: Damage dealt on collision (default: 1/4 of max HP)
        """
        super().__init__(x, y)
        
        self.projectile_id = projectile_id
        self.owner_id = owner_id
        self.damage = damage  # Store damage value for modular damage system
