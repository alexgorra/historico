...
class ProjectileRendererComponent(Component):
    ...
    def __init__(self, size=PROJECTILE_SIZE, direction_x=1.0, direction_y=0.0):
        """
        Initialize projectile renderer.
        
        Args:
            size: Size of the projectile
            direction_x: Normalized X direction for rotation
            direction_y: Normalized Y direction for rotation
        """
        super().__init__()
        self.size = size
    ...
    def render(self, surface, camera_x, camera_y):
        ...
        if self.projectile_animation:
            ...
            if current_frame:
                ...
                # Calculate rotation angle (sprite faces right by default)
...
class Projectile(GameObject):
    ...
    def __init__(self, projectile_id, x, y, direction_x, direction_y, owner_id):
        ...
        # Add renderer component with direction for rotation
        renderer = ProjectileRendererComponent(direction_x=direction_x, direction_y=direction_y)
