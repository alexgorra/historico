...
class GameRenderer:
    def __init__(self, screen):
        ...
        # Camera position (for world scrolling)
        self.camera_x = 0
        self.camera_y = 0
    ...
    def _draw_world_borders(self):
        ...
        pygame.draw.rect(self.screen, BORDER_COLOR, 
                        (0 - self.camera_x, 0 - self.camera_y, WORLD_WIDTH, BORDER_WIDTH))
        # Bottom border
        pygame.draw.rect(self.screen, BORDER_COLOR,
                        (0 - self.camera_x, WORLD_HEIGHT - BORDER_WIDTH - self.camera_y, 
                         WORLD_WIDTH, BORDER_WIDTH))
        # Left border
        pygame.draw.rect(self.screen, BORDER_COLOR,
                        (0 - self.camera_x, 0 - self.camera_y, BORDER_WIDTH, WORLD_HEIGHT))
        # Right border
        pygame.draw.rect(self.screen, BORDER_COLOR,
                        (WORLD_WIDTH - BORDER_WIDTH - self.camera_x, 0 - self.camera_y,
                         BORDER_WIDTH, WORLD_HEIGHT))
