...
WIDTH = 800
HEIGHT = 600
PLAYER_SIZE = 100  # Backward compatibility - use PLAYER_VISUAL_SIZE instead
PLAYER_HEIGHT = 40
PLAYER_WIDTH = 40
FPS = 60

# Player visual and hitbox settings
PLAYER_VISUAL_SIZE = 100  # Size for sprite rendering/scaling
PLAYER_HITBOX_WIDTH = 30  # Width of collision box
PLAYER_HITBOX_HEIGHT = 45  # Height of collision box
PLAYER_HITBOX_OFFSET_X = 35 # X offset from player position to hitbox
PLAYER_HITBOX_OFFSET_Y = 30  # Y offset from player position to hitbox

# Debug settings
DRAW_HITBOXES = True  # Set to True to draw hitbox outlines for all entities
