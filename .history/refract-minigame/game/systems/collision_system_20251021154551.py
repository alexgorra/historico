...
"""
import pygame
from game_constants import PLAYER_VISUAL_SIZE, PROJECTILE_SIZE
...
class CollisionComponent(Component):
    ...
    def __init__(self, width=PLAYER_VISUAL_SIZE, height=PLAYER_VISUAL_SIZE, offset_x=0, offset_y=0):
        super().__init__()
        self.width = width
        self.height = height
